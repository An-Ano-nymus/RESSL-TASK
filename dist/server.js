...
const server = new McpServer({
    ...
    instructions: 'Provide a file path and keyword to receive all matches with context. Optional flags allow case-sensitive search, match limits, and line context.'
});
...
server.registerTool('keyword-search', {
